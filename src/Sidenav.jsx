...
import Shorts from './Components/Shots';
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <AppBar position="fixed" elevation={4} sx={{backgroundColor: "#ffffff", color: "#2f2f2f"}}>
        <Toolbar>
          ...
          <Typography variant="h6" noWrap component="div">
            <img src={Image} height={40} style={{marginLeft:'0px'}} />
          </Typography>
        </Toolbar>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List>
            ...
            <ListItem disablePadding sx={{ display: 'block' }} onClick={()=>setMenudata('Subcriptions')}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
        ...
        <Divider />
        <ListItem disablePadding sx={{ display: 'block' }} onClick={()=>setMenudata('Library')}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
          ...
          {menudata === 'Subcriptions' && <Subcriptions />}
          {menudata === 'Library' && <Library />}
          {menudata === 'History' && <History />}
